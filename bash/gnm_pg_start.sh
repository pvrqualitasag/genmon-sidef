#!/bin/bash
#' ---
#' title: Start Postgresql Database Server for GenMon
#' date:  2020-08-10 10:50:25
#' author: Peter von Rohr
#' ---
#' ## Purpose
#' Seamless start of postgresql database for GenMon. 
#'
#' ## Description
#' Starting an instance of the postgresql database in a singularity container instance.
#'
#' ## Details
#' The starting process can include additional preparatory steps to start the database. 
#'
#' ## Example
#' ./gnm_pg_start.sh -d <data_dir> 
#'
#' ## Set Directives
