#!/bin/bash
#' ---
#' title: Clone Repository genmon_sidef
#' date:  2020-05-10 12:30:51
#' author: Peter von Rohr
#' ---
#' ## Purpose
#' Seamless inital clone of the repository genmon_sidef. 
#'
#' ## Description
#' Clone the repository genmon_sidef onto a new remote machine.
#'
#' ## Details
...
if [ ! -d "$QHTZDIR" ]; then 
  git -C "$QSRCDIR" clone '"$GHURI"' -b '"$REFERENCE"';
else 
