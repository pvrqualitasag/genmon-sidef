...
./simg/genmon-sidef/bash/si_prp_start.sh -b $BINDROOTHOST/incoming:$BINDROOTCNTR/incoming,$BINDROOTHOST/done:$BINDROOTCNTR/done,$BINDROOTHOST/projects:$BINDROOTCNTR/projects,$BINDROOTHOST/log:$BINDROOTCNTRAPIIS
```
