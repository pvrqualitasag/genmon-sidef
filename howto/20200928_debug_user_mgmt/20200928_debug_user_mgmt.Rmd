...
## Debug SQL in php-script
The following command can be used to check sql-commands from bash

```
su -c "psql -d GenMon_CH -c \"SELECT * FROM pg_database where datname like 'PPP%';\"" postgres
```
...
* Install missing fonts: `su -c"mktexpk --mfmode / --bdpi 600 --mag 1+0/600 --dpi 600 ecrm0900" popreport`
